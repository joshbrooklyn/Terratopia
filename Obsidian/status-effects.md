...
2. Are Simple or Complex
	...
	2. Complex status effects decrement when a condition is met
...
5. List of Status Effects
	...
	3. Negative Complex
		1. Debilitate - Next attack that hits you that has an element, reduce your lowest resistance to that attack by one, then reduce Debilitate by 1
